            ...
            <table class="table table-striped table-light table-borderless">
                ...
                <?php foreach ($admit as $samp) : ?>
                    <tr>
                        ...
                        <td><a href="delevent.php?delete=<?php echo $data['id']; ?>" class="btn btn-danger" name="delete">Delete</a></td>
                        <!-- <td><a href="form.php?delete=<?php echo $data['id']; ?>" class="text-danger"><i class="fa fa-trash" aria-hidden="true" name="delete">DELETE</i></a></td> -->
                    </tr>
                <?php endforeach ?>
            </table>
        </div>
